...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/heestand-xyz/TextureMap", from: "2.3.0"),
        .package(url: "https://github.com/heestand-xyz/PixelColor", from: "3.3.0"),
        .package(url: "https://github.com/heestand-xyz/CoreGraphicsExtensions", from: "2.1.0"),
        .package(url: "https://github.com/heestand-xyz/SpatialExtensions", from: "1.1.0"),
        .package(url: "https://github.com/heestand-xyz/VideoFrames", from: "2.3.0"),
