...
The main value type in **AsyncGraphics** is a ``Graphic``. It's like an image, but with various instance methods for creating new graphics and various methods for applying effects.
